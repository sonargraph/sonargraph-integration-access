...
abstract class TaskResolutionImpl extends AbstractResolutionImpl implements ITaskDefinition
{
    ...
    public TaskResolutionImpl(final String fqName, final ResolutionType type, final Priority priority, final List<IIssue> issues,
    ...
    {
        super(fqName, type, priority, issues, matchingElementsCount, description, information, assignee, dateTime, elementPatterns,
