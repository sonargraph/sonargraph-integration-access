...
public class QualityGateIssueDiffConditionImpl extends AbstractQualityGateIssueConditionImpl implements IQualityGateIssueDiffCondition
{
    private static final long serialVersionUID = 7661893979205906036L;
    private final Check m_check;

    public QualityGateIssueDiffConditionImpl(final String kind, final String presentationKind, final String fqName, final String name,
            ...
            final List<Severity> severities, final String info, final Check check, final Status status)
    {
        ...
        assert check != null : "Parameter 'check' of method 'QualityGateThresholdIssueDiffCondition' must not be null";
