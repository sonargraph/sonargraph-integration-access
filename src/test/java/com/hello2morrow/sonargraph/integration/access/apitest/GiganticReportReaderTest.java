...
public final class GiganticReportReaderTest
{
    ...
    public void processReport()
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            //            final Result result = controller.loadSystemReport(new File("D:/07_test/Sonargraph.xml"));
            final Result result = controller.loadSystemReport(new File("D:/07_test/Sonargraph_Snapshots/Sonargraph.xml"));
            assertTrue(result.toString(), result.isSuccess());
            System.out.println(i + ". Time needed to read report: " + (System.currentTimeMillis() - start));
