...
public class TestFixture
{
    ...
    public static final String REPORT_WITH_INDIVIDUAL_RESOLUTION_TYPES = "./src/test/resources/ResolutionTypes.xml";
    ...
    public static final String REPORT_WITH_ARCHITECTURE_SYSTEM_FILES = "./src/test/resources/AlarmClock_with_architecture.xml";
